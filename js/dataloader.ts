...
function createCardsManager(jsonArray: Array<sunglassesCard>) {
    let name: string;
    let picture: string;
    let rowName: string;

    jsonArray.forEach(function (item: sunglassesCard) {
        cardCounter++;
...
function createCard(name: string, picture: string, rowName: string) {
